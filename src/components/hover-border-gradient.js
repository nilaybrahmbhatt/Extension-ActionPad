...
export function HoverBorderGradient({
  ...
  const movingMap = {
    TOP: "radial-gradient(20.7% 50% at 50% 0%, hsl(222, 70%, 50%) 0%, rgba(255, 255, 255, 0) 100%)",
    LEFT: "radial-gradient(16.6% 43.1% at 0% 50%, hsl(160 60% 45%) 0%, rgba(255, 255, 255, 0) 100%)",
    BOTTOM:
      "radial-gradient(20.7% 50% at 50% 100%, hsl(30 80% 55%) 0%, rgba(255, 255, 255, 0) 100%)",
    RIGHT:
      "radial-gradient(16.2% 41.199999999999996% at 100% 50%, hsl(340 75% 55%) 0%, rgba(255, 255, 255, 0) 100%)",
  };
